...
local function SetTabLabel(self, index, label)
  ...
  if tab.labelFrame.ResizeToDefault then
    tab.labelFrame:ResizeToDefault()
  end
...
function Library.LibSimpleWidgets.TabView(name, parent)
  ...
  local tabContent = UI.CreateFrame("Frame", name.."Content", widget)
  tabContent:SetBackgroundColor(ACTIVE_TAB_R, ACTIVE_TAB_G, ACTIVE_TAB_B, 1)
  tabContent:SetPoint("TOPLEFT", widget, "TOPLEFT", 5, 5)
  tabContent:SetPoint("BOTTOMRIGHT", widget, "BOTTOMRIGHT", -5, -32)
  tabContent:SetLayer(1)
  Library.LibSimpleWidgets.SetBorder(tabContent, 1, 0.27, 0.27, 0.27, 1)
